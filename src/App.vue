  ...
  <div id="app" class="flex">
    ...
    <div class="flex flex-col min-h-screen h-screen">
      ...
      <div class="bg-green-300 flex-1 flex overflow-y-hidden">
        <div class="bg-pink-200 w-56 flex-none flex flex-col justify-between">
          <div class="overflow-y-auto">
          ...
          <div class="bg-gray-200">buttom</div>
        </div>

        <div class="bg-blue-100 flex-1 flex justify-between overflow-y-hidden">
          <div class="bg-green-100 flex-1 flex flex-col justify-between">
            <div class="overflow-y-auto">
